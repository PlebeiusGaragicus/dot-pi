 ...
 *
 * When you use the /pr or /is prompt templates with a GitHub URL, this extension
 * displays a persistent widget showing the PR/issue metadata (title, author, etc.)
 * above the editor for easy reference during review.
 *
 * Usage:
 *   pi -e extensions/project-scoped/prompt-url-widget.ts
 */
