/**
 * Timed Confirm Extension
 *
 * Demonstrates timed dialogs with live countdown using timeout option
 * and AbortSignal for auto-dismissing dialogs.
 *
 * Commands:
 ...
 *
 * Usage:
 *   pi -e extensions/examples/patterns/timed-confirm.ts
 */
