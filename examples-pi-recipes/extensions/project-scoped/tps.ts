 ...
 *
 * Displays a notification after each agent turn showing tokens-per-second
 * throughput for the LLM response. Useful for benchmarking model performance.
 *
 * Usage:
 *   pi -e extensions/project-scoped/tps.ts
 */
