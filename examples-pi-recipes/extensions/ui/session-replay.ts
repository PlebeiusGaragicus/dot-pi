 ...
 *
 * Renders a navigable, keyboard-driven overlay showing the full conversation
 * history as a vertical timeline. Each entry (user, assistant, tool) is
 * displayed with timestamps and elapsed time.
 *
 * Shortcuts:
 *   Ctrl+R         — toggle the replay overlay
 *   Up/Down/j/k    — scroll through entries
 *   Escape         — close overlay
 *
 * Usage: pi -e extensions/ui/session-replay.ts -e extensions/ui/minimal.ts
 */
