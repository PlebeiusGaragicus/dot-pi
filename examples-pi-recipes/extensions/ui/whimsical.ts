/**
 * Whimsical — Fun "Thinking..." replacements
 *
 * Swaps the default "Thinking..." working message with random whimsical phrases
 * like "Consulting the void...", "Bribing the compiler...", etc.
 *
 * Usage: pi -e extensions/ui/whimsical.ts
 */
