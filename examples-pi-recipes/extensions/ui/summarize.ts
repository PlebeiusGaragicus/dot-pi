 ...
 * Summarize Extension
 *
 * Summarizes the current conversation using an LLM and displays it
 * in a custom transient UI overlay with markdown rendering.
 *
 * Usage:
 *   pi -e extensions/ui/summarize.ts
 *
 * Usage: /summarize
 */
