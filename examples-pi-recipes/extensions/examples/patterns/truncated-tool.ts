/**
 * Truncated Tool Extension
 *
 * Demonstrates proper output truncation for custom tools.
 * Wraps ripgrep with truncation (50KB/2000 lines), writes full output
 * to a temp file when truncated, and informs the LLM where to find it.
 *
 * Usage:
 *   pi -e extensions/examples/patterns/truncated-tool.ts
 */
