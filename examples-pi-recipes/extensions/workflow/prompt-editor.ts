/**
 * Prompt Editor — Model + thinking-level mode management
 *
 * Manages named "modes" (model + thinking level combos) stored in .pi/modes.json.
 * Provides /mode to select, Ctrl+Shift+M to pick, Ctrl+Space to cycle.
 * Includes prompt history loaded from session files and a custom editor component.
 *
 * Usage: pi -e extensions/workflow/prompt-editor.ts
 */
