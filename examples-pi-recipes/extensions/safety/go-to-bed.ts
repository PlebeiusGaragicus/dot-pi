/**
 * Go To Bed — Late-night safety guard
 *
 * Blocks tool execution during quiet hours (00:00-05:59 by default). Injects a
 * system prompt encouraging sleep. The user can override by running a specific
 * confirmation command in bash.
 *
 * Usage: pi -e extensions/safety/go-to-bed.ts
 */
